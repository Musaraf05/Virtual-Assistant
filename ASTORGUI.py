...
class Ui_ASTOR(object):
    def setupUi(self, ASTOR):
        ...
        self.Background.setPixmap(QtGui.QPixmap("/Users/musaraf/Downloads/ROSTA/GUI gif/RECO.gif"))
        ...
        self.initating.setPixmap(QtGui.QPixmap("/Users/musaraf/Downloads/ROSTA/GUI gif/initalising.gif"))
        ...
        self.Faceid.setText("")
        self.Faceid.setPixmap(QtGui.QPixmap("/Users/musaraf/Downloads/ROSTA/GUI gif/FACE ID.gif"))
